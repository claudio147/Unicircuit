...
<body>
	...
	<section id="home" class="pfblock-image screen-height">
		...
		<div class="intro">
			<div class="start">archconsulting</div>
			<h1>Unicircuit</h1>
			<!--<div class="pfblock-line"></div>-->
			<div class="start">Der Grundstein für glückliche Kunden.</div>
		</div>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="custom-collapse">
					<ul class="nav navbar-nav navbar-right">
						<li><a href="#product">Das Produkt</a></li>
						<li><a href="#gallery">Galerie</a></li>
                        <li><a href="#edge">Vorteile</a></li>
	...
	<section id="gallery" class="pfblock">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-sm-offset-3">
					...
					<div class="pfblock-header wow fadeInUp">
						<h2 class="pfblock-title">Screen Galerie</h2>
						<div class="pfblock-line"></div>
					</div>
    ...
    <section class="pfblock pfblock-gray" id="edge">
	...
	<section id="aboutus" class="pfblock pfblock-gray">
