                    ...
                    <div class="col-sm-6 col-sm-offset-3">
                        <form id="contact-form">
                            <div class="ajax-hidden">
                                ...
                                <input type="email" class="c_important form-control" id="h_email" name="h_email" placeholder="Bitte nicht ausfüllen">
                                <input type="text" class="c_important form-control" id="h_time" name="h_time" value="<?php echo time();  ?>">
